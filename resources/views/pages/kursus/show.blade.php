    ...
    <div class="row d-flex">
        ...
        <div class="col-md-8 h-100">
            ...
            <div class="d-flex justify-content gap-3 mb-5">
                <a href="#" class="btn btn-primary custom-left-btn mt-5">Deskripsi</a>
                <a href="#" class="btn btn-outline-primary custom-right-btn mt-5">Ulasan</a>
            </div>
            ...
            <div class="mb-5 pb-5">
                <div class="card py-2 custom-card">
                    <div class="card-body">
                        ...
                        <p>
                            Kelas ini ditujukan untuk kamu yang sudah menguasai dasar MikroTik dan ingin melangkah lebih jauh.
                            Peserta akan belajar mengelola interface lanjutan, memperkuat keamanan jaringan, mengatur QoS, dan memahami konsep routing.
                            Kelas ini memberikan pemahaman teknis yang dibutuhkan oleh administrator jaringan profesional.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>Security hardening dan best practices</li>
            ...
            <div class="card custom-card">
                ...
                <div class="d-flex justify-content-center align-items-center mt-5">
                    <div class="card">
                        <div class="card-body-detail-kursus text-center">
                            <h3>Harga Kursus:</h3>
                            <p class="mb-1"><del>Rp. 300.000,00</del></p>
                            <h2>Rp. 180.000,00</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="text-center">
                        <a href="#" class="tombolkuning btn my-3">Beli Sekarang</a>
                    </div>
