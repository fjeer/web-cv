    ...
    <div class="container py-5">
        ...
        <div id="kelasJaringan" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                @foreach ($kursus->where('id_kelas', 1)->chunk(3) as $index => $chunk)
        ...
        <div id="kelasProgramming" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">

                @foreach ($kursus->where('id_kelas', 2)->chunk(3) as $index => $chunk)
                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                        <div class="row mt-5">
            ...
            <button class="carousel-control-prev custom-arrow" type="button" data-bs-target="#kelasProgramming"
                data-bs-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </button>

            <button class="carousel-control-next custom-arrow" type="button" data-bs-target="#kelasProgramming"
                data-bs-slide="next">
                <span class="carousel-control-next-icon"></span>
            </button>
        </div>
