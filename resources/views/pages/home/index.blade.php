    ...
    <div class="container-fluid px-4">
        ...
        <section class=" d-flex align-items-center">
            <div class="row w-100 align-items-center">
                ...
                {{-- GRID 1 — TEXT --}}
                <div class="col-md-5">
                    <h1 class="pb-4" style="font-size: 50px;">Selamat Datang Kembangkan potensi dan inovasi bersama di
                        SigmaTech.id</h1>
                    <p>
                ...
                <div class="row g-4 text-center ">
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 text-center p-3 custom-card">
                            ...
                            <div class="d-flex justify-content-center mb-3">
                                <img src="{{ asset('images/image 11.png') }}" alt="Logo" style="width: 80px;">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 text-center p-3 custom-card">
                            ...
                            <!-- Center image -->
                            <div class="d-flex justify-content-center mb-3">
                                <img src="{{ asset('images/image 10.png') }}" alt="Logo" style="width: 80px;">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 text-center p-3 custom-card">
                            ...
                            <!-- Center image -->
                            <div class="d-flex justify-content-center mb-3">
                                <img src="{{ asset('images/image 9.png') }}" alt="Logo" style="width: 80px;">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 text-center p-3 custom-card">
                            ...
                            <!-- Center image -->
                            <div class="d-flex justify-content-center mb-3">
                                <img src="{{ asset('images/image 8.png') }}" alt="Logo" style="width: 80px;">
                            </div>
        ...
        <section class="min-vh-100 d-flex flex-column justify-content-center text-center">
            ...
            <p>
                Mulai perjalanan kariermu di bidang yang kamu minati. Setiap kelas di SigmaTech dirancang agar kamu bisa
        ...
        <section class="min-vh-100 d-flex align-items-center mb-5">
            <div class="row w-100 align-items-center">
                <div class="col-md-5">
                    ...
                    <p>
                        Di SigmaTech, kamu bukan hanya belajar teknologi, tetapi juga membangun pengalaman nyata yang siap
                        dibawa ke dunia kerja.
                        Kami membekali setiap peserta dengan keahlian praktis, proyek nyata, dan sertifikat kompetensi yang
                        diakui industri.Bersama mentor profesional dan dukungan lingkungan belajar kolaboratif, kamu siap
                    ...
                    <button class="btn btn-primary" style="color: white; box-shadow: 2px 2px 5px rgba(0,0,0,0.3);">Belajar
                        Sekarang →</button>
                </div>
